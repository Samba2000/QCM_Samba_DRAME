...
<body>
 <?php est_connecté(); ?>
<div style="width: 90%; background-color: #51bfd0; height: 80px;font-weight: bold; margin-left: 5%; border-radius: 5px 5px 0px 0px; margin-top: 1%;">
  <h2 style="float: left;  margin-left: 32%; color: #f8fdfd; padding:10px;">CREER ET PARAMETRER VOS QUIZZ</h2> <br>
      <h3 style="float: right;  background-color: #3addd6; width: 120px; height: 35px; margin-top: 2px; margin-right: 2%; color: #f8fdfd; border-radius: 2px 2px 2px 2px; ">
      <a href="index.php?statut=logout" style="padding:10px; text-decoration: none;">Deconnexion</a></h3></strong>
