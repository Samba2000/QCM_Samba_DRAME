...
<div style="width:90%; height:520px; margin-left: 5%; background-color:white; margin-top:0.5%; border-radius: 5px 5px 5px 5px;">
...
if(!empty($_POST))
{
    ...
    if($PageEncour!=1)
    {
        ...
        header('location:index.php?lien=jeux&page='.$precedent.'');
    }
    if($PageEncour<$nbreDePage)
    {
        $suivant=$PageEncour+1;
        header('location:index.php?lien=jeux&page='.$suivant.'');
    }
else
    {
        header('location: index.php?lien=jeux&nom=2');
    }
...
if($PageEncour!=1)
  {
      echo "<button type='submit' style='padding:5px;float:left; background-color: darkturquoise;border-radius: 5px 5px 5px 5px;
      width: 80px; height:30px; margin-top:-3%'>Précédent</button>";
  }
  if($PageEncour<$nbreDePage)
  {
      echo "<button type='submit' style='padding:5px;margin-left:63%; background-color: darkturquoise;border-radius: 5px 5px 5px 5px;
      width: 80px; height:30px; margin-top:-3%'>Suivant</button>";
  }
  else
  {
    echo "<button type='submit' style='padding:5px;margin-left:63%; background-color: darkturquoise;border-radius: 5px 5px 5px 5px;
    width: 80px; height:30px; margin-top:-4%'>Terminer</button>";
  }
?>
</fieldset>
<div class="sub-menu">
          <div class="A">
           <a href="index.php?lien=jeux&nom=1" style="margin-left: 5%; text-decoration: none;">Top score</a>
          </div>
          <div class="A">
            <a href="index.php?lien=jeux&nom=2" style="margin-left: 5%; text-decoration: none;">Mon meileur score</a>
          </div>
</div>
